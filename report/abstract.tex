...
\noindent 
	...
	This has been an incentive to research how self-driving cars joining that join their human-steered counterparts effects the flow of traffic, most notably by \citeauthor{dresner2007sharing}. However, as far as we could find, all simulations in this area propose significant changes in infrastructure. Although changing infrastructure may make sense in the future, if autonomous cars are more commonplace, currently it is quite unlikely that policymakers will invest in changed infrastructure. 
