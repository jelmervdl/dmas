...
\jelmer{Ik heb eenheden toegevoegd, aan deze tabel, zou jij kunnen checken of die kloppen.}
\jelmer{Wat is de eenheid van power?}
\algemeen{De vision range is een beetje vreemd zo, best nuttig zo'n verslag, maar dat wordt uiteindelijk een eigenschap van de versschillende drivers. Mij lijkt hem splitsen in hoek, 360 graden voor autonomous, 60 ofozo voor human, en een radius mij niet zo heel gek. }
	\begin{table}
		\centering
		\begin{tabularx}{\textwidth}{>{\ttfamily}llX}
			...
			% bodyFixture 			& unit & The `fixture' of the bocy of a vehicle, used when viewing other vehicles\\ 
