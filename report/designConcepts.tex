...
\later{Hier kan vrij snel ook uitleggen over gedragingen van de drivers en waarom, met iets aan theorie-achtergrond. Hiervoor moeten we eerst iets meer gedraging hebben.}
...
\algemeen{Dus wat kan een mens waarnemen?} \algemeen{Wat kan een self-driving car waarnemen?}
\jelmer{De sources en sinks kunnen ook dingen waarnemen, toch? Moeten die hier dan niet ook genoemd? Jelmer: Ik denk van niet, zij dienen alleen als beginpunt en hoewel ze wel als agenten werken zijn ze niet relevant voor het onderzoek of de resultaten.}
