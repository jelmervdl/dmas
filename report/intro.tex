%!TEX root = report.tex
\todo[inline, color=green]{Introductie voor introductie}

\subsection{Problem}
\label{sub:intro:problem}
\todo[inline, color=green]{Beschrijf het probleem}
...
% problem
\todo[inline, color=green]{Meer geblaat over dat files en botsingen naar zijn en geld kosten.}
