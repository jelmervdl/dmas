...
\vdbraak{De vision range is een beetje vreemd zo, best nuttig zo'n verslag, maar dat wordt uiteindelijk een eigenschap van de versschillende drivers. Mij lijkt hem splitsen in hoek, 360 graden voor autonomous, 60 ofzo voor human, en een radius niet zo heel gek. }
	\begin{table}
		\centering
	...
	\vdbraak{Check that the high-level parameters are still accurate}
