...
\todo[inline]{commentaar van Bart hier was: Perhaps first informally describe your simulation, then move to the ODD description. Otherwise too abstract, no fun to read.}
